...
We in this section study the probability spaces of the form \(\para{\Omega, \eventSpace, \Prob}\) where
\[
    \Omega = \brce{\omega_1, \omega_2, \ldots} \quad \text{and} \quad \eventSpace = \powerset\para{\Omega}.
\]
...
\begin{definition}[Random Variable]
    ...
    For a probability space \(\para{\Omega, \eventSpace, \Prob}\), a \emph{random variable} is a function \(\functiondomain{X}{\Omega}{\RR}\) with the property that for all \(x \in \RR\), we have
    \[
        \set{\omega \in \Omega}{X\para{\omega} \leq x} = X\inverse \para{\ocintv{-\infty}{\omega}} \in \eventSpace.
    \]
\end{definition}
