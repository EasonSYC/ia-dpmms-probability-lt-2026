...
\begin{example}[Simpson's Paradox]
    ...
    \begin{align*}
        ...
        &= \frac{\Prob\para{\Conditional{A}{B \cap C}} \cdot \Prob{B \cap C}}{\Prob\para{C}} + \frac{\Prob\para{\Conditional{A}{B \compl \cap C}} \cdot \Prob\para{B\compl \cap C}}{\Prob\para{C}} \\
